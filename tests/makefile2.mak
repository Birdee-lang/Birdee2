...
all: $(OUT_DIR) autoclose_test.test array_literal.test interface_test.test class_inherit_import.test container_test.test concurrent_test.test defer_test.test exception_test.test file_test.test \
